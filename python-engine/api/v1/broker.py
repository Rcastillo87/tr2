...
def _sign_bybit(api_key: str, api_secret: str, params: dict) -> dict:
    """Genera la firma HMAC-SHA256 requerida por Bybit V5."""
...
async def validate_credentials(
    ...
    try:
        ...
        headers = _sign_bybit(request.api_key, request.api_secret, params)
