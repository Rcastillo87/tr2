...
<head>
    ...
    <title>Error del servidor — tr-bot</title>
...
<body class="font-sans antialiased" style="background:var(--color-base); color:var(--color-text-primary);">
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-10 relative overflow-hidden">
        ...
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[480px] h-[480px] rounded-full pointer-events-none"
             style="background: radial-gradient(circle, var(--color-loss) 0%, transparent 70%); opacity: 0.10; filter: blur(40px);"></div>

        <div class="relative z-10 flex flex-col items-center w-full max-w-sm text-center">

            <div class="mb-6 w-16 h-16 rounded-2xl overflow-hidden shadow-lg" style="border:1px solid var(--color-border-soft); box-shadow: 0 8px 30px rgba(242,84,91,0.15);">
                <img src="/icons/icon-192x192.png" alt="tr-bot" class="w-full h-full object-cover">
            </div>

            <p class="font-mono text-5xl font-medium mb-2" style="color:var(--color-loss);">500</p>
            <h1 class="text-lg font-semibold mb-2" style="color:var(--color-text-primary);">Algo salió mal</h1>
            <p class="text-sm mb-6" style="color:var(--color-text-muted);">
                Ocurrió un error inesperado en el servidor. Intenta de nuevo en unos momentos.
            </p>
            ...
            <div class="mt-6 flex items-center gap-2 px-3 py-1.5 rounded-full" style="background:var(--color-surface-raised); border:1px solid var(--color-border-soft);">
                <span class="relative flex h-2 w-2">
                    <span class="absolute inline-flex h-full w-full rounded-full opacity-75" style="background:var(--color-loss);"></span>
                    <span class="relative inline-flex rounded-full h-2 w-2" style="background:var(--color-loss);"></span>
                </span>
                <span class="text-[11px]" style="color:var(--color-text-secondary);">Revisando el sistema</span>
            </div>
        </div>
    </div>
</body>
